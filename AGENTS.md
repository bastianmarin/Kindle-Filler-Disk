...
Kindle Disk Filler Utility: creates large dummy files to fill Kindle storage and block automatic updates. Scripts live in `Scripts/` and run directly via curl.
...
- `Scripts/Filler.ps1` — Windows/PowerShell
- `Scripts/Filler.sh` — Linux/macOS
